...
**Below are things not related to you, just a list of reminder for myself on how to edit directly on my github.**
{: .notice}
...
can also use `<kbd>` tag for keyboard buttons
...
**Watch out!**  can also add notices by appending `{: .notice}` to a paragraph.
{: .notice}
